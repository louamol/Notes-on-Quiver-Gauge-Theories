...
\section{Strings on orbifolds}
    ...
    \subsection{Lagrangian}
        ...
        There is a Yukawa coupling for each triangle of the quiver consisting of two fermionic arrows and a bosonic arrow and a quartic scalar interaction for each square consisting of four bosonic arrows.
    ...
    \subsection{Fractional branes}
        ...
        %For fractional D-branes at an orbifold singularity, the boundary states are sums of boundary states foreach $g$-twisted sector of the closed string 2d CFT.

    \subsection{A note on couplings}
