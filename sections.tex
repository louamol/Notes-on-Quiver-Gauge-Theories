...
\section{Supersymmetric Yang-Mills theories from D-branes}
...
\section{$\mN=4$ super Yang-Mills theory in $D=4$}\label{sec:N4SCFT}
...
\section{Strings on orbifolds}
    ...
    \subsection{Spacetime geometry: ALE space and orbifolds}\label{app:spacetimegeom}
...
\section{Singular transverse space: orbifold singularities}\label{sec:orbsing}
    ...
    \subsection{Generalities}
        ...
        \begin{details}
            \textbf{Details.} Riemannian symmetric spaces, which are locally isometric to homogeneous spaces $G/H$ have local holonomy isomorphic to $H$.\marker
        \end{details}
