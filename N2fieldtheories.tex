...
\section{Classical moduli space}
    ...
    The D-term and F-term equations are \todo{Verify how to obtain these equation from the F-terms and D-terms}
    \begin{figure}[H]
        \centering
        $
        \begin{array}{|cc|}
    ...
    \subsection{Higgs branch}
        ...
        \subsubsection{Flavor symmetry}
            ...
            \underline{Non-baryonic branches:}\todo{Redo those computations} on these branches, the baryonic field vanishes, $B=\tilde{B}=0$, hence their name, and the meson field is given by
            \begin{equation}
                M=
                \begin{bmatrix}
                    0 & & & \kappa^2_1 & & & 0 & \\
    ...
    \subsection{Summary}
        ...
        The classical moduli space is composed of the following branches:
        \begin{figure}[H]
            \centering
            {\small
            \begin{tabular}{|c|c|c|l|}
                ...
                \begin{tabular}{@{}c@{}}Baryonic \\ $N_f\geq 2N_c$\end{tabular} & $0$ & $\U(N_f-2N_c)\times\U(1)^{N_c-1}\times\SU(2)'_R$ & \begin{tabular}{@{}l@{}}$\mP = N_c+3$ \\ $\H = N_fN_c-N^2_c-1$ \\ $\G = 4N_fN_c-4N^2_c+1$ \\ $\V = 0$ \end{tabular} \\ \hline
                \begin{tabular}{@{}c@{}}Baryonic \\ $N_c\leq N_f\leq 2N_c$\end{tabular} & $0$ & $\U(2N_c-N_f)\times\U(1)^{N_f-N_c}\times\SU(2)'_R$ & \begin{tabular}{@{}l@{}}$\mP = N_f-N_c+3$ \\ $\H = N_fN_c-N^2_c-1$ \\ $\G = 4N_fN_c-4N^2_c-N_f+N_c+1$ \\ $\V = 0$ \end{tabular} \\ \hline
