...
\section{Classical moduli space}
    ...
    \subsection{Summary}
        ...
        \begin{itemize}
            ...
            \item \textbf{Non-baryonic branches:} contains the mixed branches and part of the Higgs branch: \eqref{eq:nonbaryonicbranch} when $2\leq N_f<2N_c$. It has $\V=N_c-1-r$ and $\H= r(N_f-r)$ with $1\leq r\leq \min\{\lfloor N_f/2\rfloor,N_c-2\}$. Each $r$ parametrizes a different branch.
