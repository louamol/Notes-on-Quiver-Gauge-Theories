        ...
        \begin{itemize}
            ...
            \begin{equation}
                ...
                \begin{cases}
                    ...
                    \frac{1}{2}\left( \frac{m^2}{2}-1 \right),\qquad\text{if $m$ is odd}
            ...
            \end{equation}
            and we already now the second term from the case $r=0$.
        \end{itemize}
        In the end, we get that
        \begin{equation}
            \sum^{\lfloor n/3\rfloor}_{a=1}~\left\lfloor \frac{n-3a}{2}\right\rfloor=
            \begin{cases}
                ,\qquad\text{if $n=3m$ is even}\\
                ,\qquad\text{if $n=3m+1$ is odd},\\
                ,\qquad\text{if $n=3m+2$ is odd}
            \end{cases}.
        \end{equation}
