        ...
        \subsubsection{Finite subgroups}
            ...
            \begin{itemize}
                ...
                \begin{equation}
                    ...
                    \end{bmatrix}
                \end{equation}
                One can show that $A^n=B^2$ and that $AB=BA^{-1}$ so that $\D_n=\{B^bA^a|0\leq b \leq 3, 0\leq a \leq n-1\}$. This rewriting of the most general element of the group will be useful. Note that $2\D_1=\Z_2$ and $2\D_2=\Z_4$.
