...
\section{The simplest case: $S=\C^3$}
    ...
    \subsection{Matter content}
        ...
        \begin{align}
            ...
            X&\in\boldsymbol{6}\otimes\Hom(\C^n,\C^n).
        \end{align}
...
\section{Projection to daughter theories}
    ...
    \subsection{Generalities}
        ...
        \end{align}
        are kept in the spectrum. Note that the fields that transform non-trivially under R-symmetry also have an extra induced action of $\Gamma$. The R-symmetry untouched by $\Gamma$ will be the resulting R-symmetry of daughter theory.
