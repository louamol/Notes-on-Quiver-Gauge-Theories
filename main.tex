...
\section{$\mN=1$ daughter theories}
    ...
    \subsection{$S=\C^3/\Z_3$}
        ...
        Let us consider the representation $(\rho,\C^N)$ of $\Z_3$. A complete set of irreducible representations of $\Z_3$ is given by $\{(\rho_k,V_k)\}_{k=0,1,2}$ with $V_k=\C$ and
        \begin{equation}
            \rho_i(g)=\zeta^k_3
        \end{equation}
        ...
        \begin{align}
            ...
            \bar{X}^m_{i\alpha_i,j\beta_j}\mapsto  \xi^{-1}_n\delta\indices{^m_n}\rho_i(g) X^n_{i\alpha_i,j\beta_j}\rho_j(g)^{-1} = \xi^{i-j-1}X^m_{i\alpha_i,j\beta_j}
        \end{align}
        ...
        \begin{equation}
            ...
            X^m_{21}\in(\boldsymbol{\textbf{N}_{2}},\boldsymbol{\bar{\textbf{N}}_0}).
        \end{equation}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \foreach \n in {0,...,2}{
                    ...
                    \draw ({120*\n+30}:1) node[rotate={120*\n-60}]{$ \blacktriangleright\blacktriangleright\blacktriangleright$};
                }
                \draw (-30:2.45) node{$N_0$};
                \draw (90:2.45) node{$N_1$};
                \draw (210:2.45) node{$N_2$};
            \end{tikzpicture}
            \caption{Quiver of the $\Z_3$ daughter theory.}
            \label{fig:Z3quiver}
        \end{figure}
